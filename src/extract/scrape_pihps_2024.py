...
# ===============================
# DAFTAR KOMODITAS RESMI BI
# sesuai dropdown website
# ===============================
...
def main():
    ...
    print("Mulai scraping data harga pangan BI 2024...\n")
    ...
    raw_path = data_dir / "harga_harian_2024_raw.csv"
    ...
    df_valid["tanggal"] = pd.to_datetime(
        df_valid["tanggal"]
    )
    ...
    harian_path = data_dir / "harga_harian_2024.csv"

    bulanan_path = data_dir / "harga_bulanan_2024.csv"
    ...
    print("\nSelesai scraping 2024 🎉")
    print(f"Raw data   : {raw_path}")
    print(f"Harian     : {harian_path}")
    print(f"Bulanan    : {bulanan_path}")
